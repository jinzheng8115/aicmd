...
| `aicmd update --version <TAG>` | Install a specific version. | `aicmd update --version v0.30.10` | Useful for rollback or pinning. |
...
# or download install.ps1 and run: .\install.ps1 -Version v0.30.10
```
