...
```bash
sh -c 'curl -fsSL https://raw.githubusercontent.com/jinzheng8115/aicmd/main/contrib/aicmd/install.sh | bash -s -- --version v0.30.2'
```
...
target/debug/aicmd update --version v0.30.2 --dry-run
```
